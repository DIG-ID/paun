<section class="section-unser-antrieb pt-8 pb-44 bg-bg-color overflow-hidden w-11/12 mx-auto border-t-2 border-text-color">
    ...
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 py-28">
        ...
        <div class="col col-span-1 lg:col-span-2 border-b-2 border-text-color pb-32 mb-28">
            ...
            <a href="<?php the_permalink(); ?>" class="text-button flex items-center"><?php esc_html_e( 'Mehr erfahren', 'paun' ) ?><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/Arrow-more.svg" class="mr-4"></a>
        </div>
        <?php endwhile;
        endif;
        wp_reset_postdata();
