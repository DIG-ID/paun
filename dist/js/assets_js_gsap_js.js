(self["webpackChunkpaun"] = self["webpackChunkpaun"] || []).push([["assets_js_gsap_js"],{
...
document.addEventListener('DOMContentLoaded', function () {
  if ($(window).width() > 640) {
    ...
    var animateLogo = function animateLogo() {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.home .header-logo', {
        width: '7rem',
        duration: 0.5,
        ease: 'power2.out'
      });
    };
    var resetLogo = function resetLogo() {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.home .header-logo', {
        width: '100%',
        duration: 0.5,
        ease: 'power2.out'
    ...
    var logo = document.querySelector('.home .header-logo');
...
//# sourceMappingURL=assets_js_gsap_js.js.map